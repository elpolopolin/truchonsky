...
export const AuthProvider = ({ children }) => {
  ...
  const login = async (email, password) => {
    try {
      const response = await axios.post('https://skilled-obviously-earwig.ngrok-free.app/api/login', { email, password });
  ...
  const verifyAuth = useCallback(async () => {
    try {
      ...
      const response = await axios.get('https://skilled-obviously-earwig.ngrok-free.app/api/verified', {
        headers: {
