  ...
  const AllProducts = ({ productsPerPage, productoAbuscar }) => {
    ...
    useEffect(() => {
      const fetchProducts = async () => {
        try {
          if (productoAbuscar) {
            const response = await axios.get('https://skilled-obviously-earwig.ngrok-free.app/api/productSearch', { params: { nombre: productoAbuscar } });
            ...
            const response = await axios.get('https://skilled-obviously-earwig.ngrok-free.app/api/getProducts');
