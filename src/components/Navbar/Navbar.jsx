      ...
      <div className="menu__wrapper">
        <div className="menu__bar">
          <Link to="/" title="Home" aria-label="home" className="logo">
            <img src="https://skilled-obviously-earwig.ngrok-free.app/img/logowhite.png" alt="logo" />
          </Link>
          <nav>
